...
> **Pointer**는 **primity type**을 객체 형태로 감싸서, **[call by address](https://pediaa.com/what-is-the-difference-between-call-by-value-and-call-by-address/)** 도 가능케 하는 **Class**입니다.  
