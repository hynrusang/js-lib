...
## 정보
- 이건 **kotlin**에 있는 **LiveData**를 **[js (javascript)](https://developer.mozilla.org/ko/docs/Web/JavaScript)** 에서 사용하고, **LiveDataManager(1.1.0~)** 로 여러 **LiveData**들을 손쉽게 사용할 수 있게 해주는 js 파일 입니다.  
